...
import com.darktheme.ActAds;
import com.darktheme.App;
...
*/
        Intent intent = new Intent(mContext, ActAds.class);
        ...
        if (result != null) {
            ...
            result = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.ic_settings_brightness_black_24dp);
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            notificationBuilder.setSmallIcon(R.drawable.ic_settings_brightness_black_24dp);
